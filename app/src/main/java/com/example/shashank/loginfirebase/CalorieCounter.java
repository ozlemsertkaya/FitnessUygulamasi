...
import com.example.shashank.loginfirebase.Model.Food;
import com.example.shashank.loginfirebase.ViewHolder.CategoryViewHolder;
...
public class CalorieCounter extends AppCompatActivity {
    ...
    private abstract class FirebaseRecyclerAdapter<T, T1> extends RecyclerView.Adapter {
        public FirebaseRecyclerAdapter(Class<T> foodClass, int category_item, Class<T1> categoryViewHolderClass, DatabaseReference category) {
        }

        protected abstract void populateViewHolder(CategoryViewHolder viewHolder, Food model, int position);
